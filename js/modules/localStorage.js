...
data.heroes.forEach(hero => {
    heroesLocal[hero.name.toLocaleLowerCase()] = new Hero(hero.name, hero.totalHp, hero.hp, hero.atk, hero.def, hero.thumbnail, hero.level, hero.power, hero.given_power, hero.base_cost, hero.cost_increase, hero.require);
});

data.enemies.forEach(enemie => {
    enemiesLocal[enemie.name.toLocaleLowerCase()] = new Character(enemie.name, enemie.totalHp, enemie.hp, enemie.atk, enemie.def, enemie.thumbnail);
});
